...
class WeeklyPoints {
    ...
    public function __construct( WeeklyChampionshipCompetition $weekly_competition ){

         $this->competition_id = $weekly_competition->competition_id;
         $this->league_id = $weekly_competition->league_id;
